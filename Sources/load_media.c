...
void load_map(SRC media){
    ...
    get_string("Type the file's name", title, media); //pega o nome com a interface da fun��o get_name
    char fullTitle[MAX_CHAR_NAME] = "Phases/";
    strcat(fullTitle, title); //concatena para colocar a localiza��o correta do arquivo
    puts(fullTitle);
